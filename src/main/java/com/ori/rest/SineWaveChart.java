...
public class SineWaveChart {
    ...
    public void RenderPlot() {
        ...
        if (dataset != null && dataset.getSeriesCount() > 0){
            chart = ChartFactory.createXYLineChart("title","X","Y Label",dataset,PlotOrientation.VERTICAL,true, false, false);
//            chart = ChartFactory.createXYLineChart("XY Line chart",dataset,PlotOrientation.VERTICAL,true, false, false);
        }else{
